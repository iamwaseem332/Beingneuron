...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-ink-950 text-paper">
      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-16 pt-32 sm:px-8 lg:pt-40">
        <div className="grid items-center gap-14 lg:grid-cols-12">
          <div className="lg:col-span-6">
            ...
            <h1 className="mt-7 font-display text-[2.3rem] font-bold leading-[1.05] tracking-tight sm:text-[3.3rem] xl:text-[3.55rem]">
            ...
            <Reveal delay={200}>
              <p className="mt-7 max-w-xl text-[17px] leading-relaxed text-paper/65">
            ...
            <Reveal delay={430}>
              <div className="mt-12 space-y-2 border-t border-paper/10 pt-6 text-paper/50">
                <StatusLine>
